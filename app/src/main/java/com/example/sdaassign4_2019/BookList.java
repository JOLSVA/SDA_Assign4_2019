...
public class BookList extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //for(int i=1;i<=14;i++) {
            ...
            //StorageReference gsReference = storage.getReferenceFromUrl("gs://book-club-99c23.appspot.com/sku10001.jpg");

            //String fileURL = FirebaseStorage.getInstance().getReference().getPath().toString();
            //String imagePath = fileRef.getDownloadUrl().toString();
            //String fileURL = "https://firebasestorage.googleapis.com/v0/b/book-club-99c23.appspot.com/o/images%2Fsku1000" + getString(i) + ".jpg?alt=media&token=24f6c534-7258-4d70-bfbb-503ee8d4cf4c";
